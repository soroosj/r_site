...
The example Twitter handle will be the English language account of [BVB Dortmund ("BVB")](https://www.bvb.de/eng), a football team in Germany's top professional league, the [Bundesliga](https://www.bundesliga.com/en/bundesliga).  We are using BVB's English Twitter account instead of the club's primary German language Twitter account because this blog post is written in English.
